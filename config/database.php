...
return [
    ...
    */
    ...
    'redis' => [
        ...
        'telescope' => [
            ...
            'password' => env('REDIS_PASSWORD'),
            'port' => env('REDIS_PORT', '6379'),
            'database' => env('REDIS_TELESCOPE_DB', '5'),
        ],
    ...
    */
    ...
    'pool' => [
        ...
        'connection_timeout' => env('DB_POOL_CONNECTION_TIMEOUT', 10),
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Configure query logging settings.
    |
    */

    'logging' => [
        'enabled' => env('DB_LOGGING_ENABLED', false),
        'slow_query_threshold' => env('DB_SLOW_QUERY_THRESHOLD', 1000), // milliseconds
        'log_channel' => env('DB_LOG_CHANNEL', 'daily'),
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Configure query caching settings.
    |
    */

    'query_cache' => [
        'enabled' => env('DB_QUERY_CACHE_ENABLED', true),
        'ttl' => env('DB_QUERY_CACHE_TTL', 300), // seconds
